              ...
              {bookingsLoading ? (
                ...
                <div className="space-y-4">
                  {bookings
                    ...
                    .map((booking) => (
                    <div key={booking.reference} className="bg-white/5 rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all group">
                      <div className="flex gap-4">
                        <div className="w-16 h-24 bg-linear-to-br from-red-600/30 to-red-700/20 rounded-lg flex items-center justify-center shrink-0">
                          <Film size={28} className="text-red-500" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              <h4 className="font-bold text-lg truncate group-hover:text-red-400 transition-colors">{booking.movie}</h4>
...
export default function ProfilePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center">
      <div className="text-center">
        <div className="w-12 h-12 border-4 border-red-600 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
        <p>Loading profile...</p>
      </div>
